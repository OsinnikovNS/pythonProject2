...
class PriceMachine:
    ...
    def search_engine(self, input_text):
        ...
        self.export_to_html(sorted_results)  # передаем отсортированный результат на экспорт
    ...
    def user_input(self, file_path):
        ...
        :return: value(text)
        """
        self.load_prices(file_path)  # передаем путь папки в load_prices
        ...
        while True:
            ...
            if find_text_value.lower() == 'exit' or find_text_value.lower() == 'выход':
                ...
                break
            self.search_engine(find_text_value)  # передаем введенное слово в поисковик
