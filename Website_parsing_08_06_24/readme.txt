...
Самые актуальные данные по криптовалютам можно найти на CoinMarketCap(https://coinmarketcap.com/ru/). На домашней странице этого сайта и находится топ-100 всех криптовалют.
...
Каждый следующий файл при записи должен иметь название в следующем формате: H.M dd.mm.yyyy, где H - Часы, M-минуты, dd- день, mm-месяц, yyyy-год.
